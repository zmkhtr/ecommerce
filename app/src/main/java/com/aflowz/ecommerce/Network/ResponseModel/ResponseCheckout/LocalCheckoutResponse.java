...
public class LocalCheckoutResponse implements Parcelable {
    ...
    public LocalCheckoutResponse() {
    }

    protected LocalCheckoutResponse(Parcel in) {
    ...
    public static final Parcelable.Creator<LocalCheckoutResponse> CREATOR = new Parcelable.Creator<LocalCheckoutResponse>() {
        @Override
        public LocalCheckoutResponse createFromParcel(Parcel source) {
            return new LocalCheckoutResponse(source);
        }

        @Override
        public LocalCheckoutResponse[] newArray(int size) {
            return new LocalCheckoutResponse[size];
        }
    };
}