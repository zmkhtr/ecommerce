...
public class HomeFragmentAdapter extends RecyclerView.Adapter<HomeFragmentAdapter.ViewHolder> implements Filterable {
    ...
    HomeFragmentAdapter(Context context) {
...
//        Uri uri = Uri.fromFile(new File(productModel.getImages()));
    ...
    void setProductModels(List<Datum> productModels1) {
        int count = getItemCount();
        productModels.addAll(productModels1);
        productModelsFull.addAll(productModels1);
//        this.productModels = productModels1;
//        productModelsFull = new ArrayList<>(productModels1);
